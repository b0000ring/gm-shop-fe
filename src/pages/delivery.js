...
const Delivery  = () => (
  <Layout> 
    ...
    <div className={clsx('content', styles.about)}>
      ...
      <h3>Оплата</h3>
      <p>
        Оплата осуществляется с помощью сервиса оплаты банка Тинькофф, который предоставляет защиту ваших данных. CYBERGEEK не получает и не хранит предоставляемую Вами платежную информацию. 
      </p>
      <h3>Доставка</h3>
      <p>
